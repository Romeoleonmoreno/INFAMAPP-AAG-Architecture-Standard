# Licencia de Propiedad Intelectual y Restricción de Uso Comercial

**© 2026 José Manuel León Moreno. Todos los derechos reservados.**

## 1. Titularidad
La "Arquitectura de Asistencia Gobernada (AAG)", incluyendo su documentación, lógica de "Núcleo Transversal", diagramas y código fuente, es propiedad exclusiva de José Manuel León Moreno.

## 2. Términos de la Licencia
Se otorga permiso para la visualización, descarga y estudio del material únicamente con fines educativos, de auditoría o de investigación personal.

## 3. Restricciones de Uso Comercial
Queda estrictamente PROHIBIDA la explotación comercial, distribución, venta o implementación de esta arquitectura en entornos productivos de terceros sin una licencia comercial expresa y firmada por el autor. 

## 4. Obras Derivadas
Cualquier modificación o variación basada en este concepto se considerará una obra derivada de la AAG y seguirá sujeta a los derechos de propiedad del autor original.
